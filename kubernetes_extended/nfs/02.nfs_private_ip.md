...
## Подготовка.
Создадим NFS сервер с приватным адресом по мануалу: https://github.com/Cameda/Yandex-Cloud/blob/main/manifests/compute/vm/05.nfs_server_with_private_address.md
